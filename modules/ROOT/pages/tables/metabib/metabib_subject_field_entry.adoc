...
:description: Table reference for metabib.subject_field_entry
...
[WARNING]
====
*Deferrable Constraints:* The following FK constraints are deferrable — they are checked at transaction end, not statement end: `metabib_subject_field_entry_field_pkey`, `metabib_subject_field_entry_source_pkey`.
====
...
| `subject_field_entry_pkey` [.label]#PK#
| btree
| `CREATE UNIQUE INDEX subject_field_entry_pkey ON metabib.subject_field_entry USING btree (id)`
