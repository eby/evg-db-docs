...
:description: Table reference for metabib.combined_keyword_field_entry
...
| `metabib_combined_keyword_field_entry_fakepk_idx` [.label]#UNIQUE#
| btree
...
| `metabib_combined_keyword_field_source_idx`
| btree
