= Schema Changes: 3.14.4
:description: Database schema changes applied in Evergreen 3.14.4

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.14.3 → 3.14.4
...
[[mig-1454]]
=== 1454 — acq invoice item fund debit fkey deferrable
