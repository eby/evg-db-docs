= Schema Changes: 3.0.11
:description: Database schema changes applied in Evergreen 3.0.11

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.0.10 → 3.0.11
...
| <<mig-1119,1119>>
| schema
| lp1775216 consistent avail counts
...
[[mig-1119]]
=== 1119 — lp1775216 consistent avail counts
