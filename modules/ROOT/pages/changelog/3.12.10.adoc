= Schema Changes: 3.12.10
:description: Database schema changes applied in Evergreen 3.12.10

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.12.9 → 3.12.10
...
| <<mig-1445,1445>>
| data
| at event def money payment receipt print
...
[[mig-1445]]
=== 1445 — at event def money payment receipt print
