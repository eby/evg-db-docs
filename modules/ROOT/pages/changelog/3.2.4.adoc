= Schema Changes: 3.2.4
:description: Database schema changes applied in Evergreen 3.2.4
...
| <<mig-1142,1142>>
| schema
| reporter simple record pubdate fix

| <<mig-1149,1149>>
| data
| circ billing history grid persist key
...
[[mig-1142]]
=== 1142 — reporter simple record pubdate fix
...
[[mig-1149]]
=== 1149 — circ billing history grid persist key
