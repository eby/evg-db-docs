= Schema Changes: 3.1.0
:description: Database schema changes applied in Evergreen 3.1.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.0.6 → 3.1.0

This release applied 20 migration(s) to the database schema.
...
| <<mig-1089,1089>>
| data
| max duplicate holds coust

| <<mig-1090,1090>>
| schema
| record merge tracking
...
| <<mig-1096,1096>>
| data
| stock copy alert types

| <<mig-1097,1097>>
| data
| yaous for open circ exists fine handling

| <<mig-1098,1098>>
| data
| move legacy copy alerts

| <<mig-1099,1099>>
| data
| more copy alerts active by default

| <<mig-1100,1100>>
| data
| display field seed data
...
| <<mig-1105,1105>>
| schema
| webstaff.circ.itemsout notice count excludes courtesies

| <<mig-1106,1106>>
| data
| expand billing timestamps

| <<mig-1108,1108>>
| schema
| lp1758347 fix merge record assets

| <<mig-1109,1109>>
| data
| yaos circ holds default pickup lib
...
[[mig-1089]]
=== 1089 — max duplicate holds coust
...
[[mig-1097]]
=== 1097 — yaous for open circ exists fine handling
...
[[mig-1099]]
=== 1099 — more copy alerts active by default
...
[[mig-1102]]
=== 1102 — mods title punctuation change
...
[[mig-1105]]
=== 1105 — webstaff.circ.itemsout notice count excludes courtesies
...
[[mig-1106]]
=== 1106 — expand billing timestamps
...
[[mig-1108]]
=== 1108 — lp1758347 fix merge record assets
...
[[mig-1109]]
=== 1109 — yaos circ holds default pickup lib
