= Schema Changes: 3.6.4
:description: Database schema changes applied in Evergreen 3.6.4
...
| <<mig-1261,1261>>
| schema
| located uris shortcut

| <<mig-1262,1262>>
| schema
| search highlight escape html

| <<mig-1263,1263>>
| data
| staffcat sticky search form
