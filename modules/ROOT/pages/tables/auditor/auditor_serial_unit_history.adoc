...
:description: Table reference for auditor.serial_unit_history
...
| `serial_unit_history_pkey` [.label]#PK#
| btree
| `CREATE UNIQUE INDEX serial_unit_history_pkey ON auditor.serial_unit_history USING btree (audit_id)`

| `aud_serial_unit_hist_creator_idx`
| btree
| `CREATE INDEX aud_serial_unit_hist_creator_idx ON auditor.serial_unit_history USING btree (creator)`

| `aud_serial_unit_hist_editor_idx`
| btree
