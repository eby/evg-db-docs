= Schema Changes: 3.0.3
:description: Database schema changes applied in Evergreen 3.0.3
...
| <<mig-1086,1086>>
| function
| copy location group visible

| <<mig-1087,1087>>
| function
| special bib vis handling
...
[[mig-1086]]
=== 1086 — copy location group visible
