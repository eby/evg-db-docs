= Schema Changes: 3.10.1
:description: Database schema changes applied in Evergreen 3.10.1

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.10.0 → 3.10.1
...
| <<mig-1355,1355>>
| data
| ang patron print template fix

| <<mig-1359,1359>>
| schema
| lp1998355 reduce symspell churn

| <<mig-1360,1360>>
| schema
| function fixes for string agg
...
[[mig-1355]]
=== 1355 — ang patron print template fix
...
[[mig-1359]]
=== 1359 — lp1998355 reduce symspell churn
...
[[mig-1360]]
=== 1360 — function fixes for string agg
