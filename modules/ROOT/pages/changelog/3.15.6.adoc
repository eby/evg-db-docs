= Schema Changes: 3.15.6
:description: Database schema changes applied in Evergreen 3.15.6

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.15.5 → 3.15.6
...
| <<mig-1486,1486>>
| schema
| hold request reset reason entry trigger

| <<mig-1487,1487>>
| schema
| virtualize user password

| <<mig-1489,1489>>
| data
| materialized simple record title fix

| <<mig-1492,1492>>
| —
| functions bib merge update for deleted parts
...
[[mig-1486]]
=== 1486 — hold request reset reason entry trigger
...
[[mig-1489]]
=== 1489 — materialized simple record title fix
...
[[mig-1492]]
=== 1492 — functions bib merge update for deleted parts
