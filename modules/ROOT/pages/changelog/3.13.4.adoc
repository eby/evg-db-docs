= Schema Changes: 3.13.4
:description: Database schema changes applied in Evergreen 3.13.4

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.13.3 → 3.13.4
...
[[mig-1429]]
=== 1429 — org setting brief record typo
...
[[mig-1431]]
=== 1431 — available copy ratio use age protection
