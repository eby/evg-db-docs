= Schema Changes: 2.12.6
:description: Database schema changes applied in Evergreen 2.12.6

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 2.12.5 → 2.12.6
