= Schema Changes: 3.15.4
:description: Database schema changes applied in Evergreen 3.15.4

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.15.3 → 3.15.4
...
| <<mig-1481,1481>>
| data
| search filter group save grid settings

| <<mig-1482,1482>>
| data
| survey save grid settings
...
[[mig-1481]]
=== 1481 — search filter group save grid settings
...
[[mig-1482]]
=== 1482 — survey save grid settings
...
[[mig-1484]]
=== 1484 — vandelay record matches grid ws settings
