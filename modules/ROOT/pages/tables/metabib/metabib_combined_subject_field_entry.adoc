...
:description: Table reference for metabib.combined_subject_field_entry
...
| `metabib_combined_subject_field_entry_fakepk_idx` [.label]#UNIQUE#
| btree
...
| `metabib_combined_subject_field_source_idx`
| btree
