= Schema Changes: 3.8.0
:description: Database schema changes applied in Evergreen 3.8.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.7.1 → 3.8.0

This release applied 42 migration(s) to the database schema.
...
| <<mig-1275,1275>>
| schema
| update fund xfr notes

| <<mig-1276,1276>>
| data
| acq admin grid settings

| <<mig-1277,1277>>
| schema
| make acqf code not null
...
| <<mig-1284,1284>>
| data
| void deposit on checkin

| <<mig-1285,1285>>
| data
| lp1905028.item value fields

| <<mig-1286,1286>>
| data
| staffcat search filters

| <<mig-1287,1287>>
| data
| my account url yaous

| <<mig-1288,1288>>
| schema
| note and message consolidation
...
| <<mig-1295,1295>>
| schema
| vandelay update edit date

| <<mig-1296,1296>>
| schema
| reporter demographic expansion

| <<mig-1297,1297>>
| data
| staff placed holds default to ws ou

| <<mig-1298,1298>>
| schema
| case insensitive browse field match

| <<mig-1299,1299>>
| function
| strip field multimatch

| <<mig-1300,1300>>
| data
| pull list print template

| <<mig-1301,1301>>
| schema
| fix bre upgrade issue
...
| <<mig-1304,1304>>
| schema
| update actor usr funcs

| <<mig-1305,1305>>
| schema
| update actor usr merge

| <<mig-1306,1306>>
| schema
| symspell speed ingest
...
[[mig-1260]]
=== 1260 — lp1908440.photo url editing
...
[[mig-1271]]
=== 1271 — org setting stripe currency
...
[[mig-1282]]
=== 1282 — did you mean optimization
...
[[mig-1285]]
=== 1285 — lp1905028.item value fields
...
[[mig-1288]]
=== 1288 — note and message consolidation
...
[[mig-1295]]
=== 1295 — vandelay update edit date
...
[[mig-1296]]
=== 1296 — reporter demographic expansion
...
[[mig-1297]]
=== 1297 — staff placed holds default to ws ou
...
[[mig-1298]]
=== 1298 — case insensitive browse field match
