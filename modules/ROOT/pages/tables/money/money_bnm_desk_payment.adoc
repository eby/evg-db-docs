...
:description: Table reference for money.bnm_desk_payment

xref:schemas/money.adoc[↑ money schema]

[WARNING]
====
*Deferrable Constraints:* The following FK constraints are deferrable — they are checked at transaction end, not statement end: `bnm_desk_payment_cash_drawer_fkey`.
====
...
| `bnm_desk_payment_pkey` [.label]#PK#
| btree
| `CREATE UNIQUE INDEX bnm_desk_payment_pkey ON money.bnm_desk_payment USING btree (id)`
