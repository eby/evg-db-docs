= Schema Changes: 2.5.0
:description: Database schema changes applied in Evergreen 2.5.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 2.4.3 → 2.5.0

This release applied 43 migration(s) to the database schema.
...
| <<mig-794,794>>
| —
| add option for including lost in items out and patron blocking by lost

| <<mig-795,795>>
| schema
| z39 batch fetch overlay
...
| <<mig-842,842>>
| schema
| redo config metabib field sequence 2 3 to 2 4

| <<mig-843,843>>
| schema
| redo config metabib field sequence 2 5

| <<mig-796,796>>
| schema
| vandelay bucket match
...
| <<mig-798,798>>
| function
| purge circulations updates

| <<mig-799,799>>
| —
| state field required toggle
...
| <<mig-802,802>>
| function
| authority sf file order

| <<mig-805,805>>
| schema
| desk renewal reuse circ lib
...
| <<mig-812,812>>
| data
| add library info url OUS

| <<mig-813,813>>
| data
| state field settings fix
...
| <<mig-829,829>>
| data
| my list items per page setting

| <<mig-830,830>>
| data
| my list lists per page setting

| <<mig-831,831>>
| schema
| long overdue penalty
...
| <<mig-834,834>>
| data
| yaous items out by stop fines

| <<mig-835,835>>
| data
| yaous disable patron credit
...
| <<mig-837,837>>
| schema
| browse auth linking.plus joiner
...
| <<mig-844,844>>
| data
| better mods for browse etc

| <<mig-845,845>>
| schema
| browse pivots stable
...
| <<mig-847,847>>
| function
| auth overlay generator

| <<mig-827,827>>
| schema
| action trigger.event definition.repeat delay
...
[[mig-794]]
=== 794 — add option for including lost in items out and patron blocking by lost
...
[[mig-842]]
=== 842 — redo config metabib field sequence 2 3 to 2 4
...
[[mig-843]]
=== 843 — redo config metabib field sequence 2 5
...
[[mig-798]]
=== 798 — purge circulations updates
...
[[mig-799]]
=== 799 — state field required toggle
...
[[mig-805]]
=== 805 — desk renewal reuse circ lib
...
[[mig-815]]
=== 815 — config metabib interauthority
...
[[mig-824]]
=== 824 — vandelay item import defaults
...
[[mig-829]]
=== 829 — my list items per page setting
...
[[mig-830]]
=== 830 — my list lists per page setting
...
[[mig-834]]
=== 834 — yaous items out by stop fines
...
[[mig-835]]
=== 835 — yaous disable patron credit
...
[[mig-837]]
=== 837 — browse auth linking.plus joiner
...
[[mig-839]]
=== 839 — alternative title indexing
...
[[mig-844]]
=== 844 — better mods for browse etc
...
[[mig-827]]
=== 827 — action trigger.event definition.repeat delay
