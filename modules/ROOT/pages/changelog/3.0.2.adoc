= Schema Changes: 3.0.2
:description: Database schema changes applied in Evergreen 3.0.2
...
| <<mig-1080,1080>>
| schema
| lp1724246 cache copy visibility

| <<mig-1081,1081>>
| schema
| lp1724223 re inherited

| <<mig-1082,1082>>
| data
| lp1731281 acvac cleanup

| <<mig-1083,1083>>
| scema
| qualify unaccent refs
...
[[mig-1080]]
=== 1080 — lp1724246 cache copy visibility
...
[[mig-1084]]
=== 1084 — webstaff.cat.copy.templates
