...
_Generated 2026-04-17. Do not edit — regenerate with `make generate`._ Also available as an interactive diagram on link:https://dbdocs.io/eby/evergreen[dbdocs.io^] and as a link:{attachmentsdir}/evergreen.dbml[downloadable DBML schema file].
