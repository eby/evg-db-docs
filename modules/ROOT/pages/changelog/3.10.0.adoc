= Schema Changes: 3.10.0
:description: Database schema changes applied in Evergreen 3.10.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.9.1 → 3.10.0

This release applied 21 migration(s) to the database schema.
...
| <<mig-1326,1326>>
| data
| field documentation workstaiton setting
...
| <<mig-1330,1330>>
| data
| negative balance grid

| <<mig-1331,1331>>
| data
| hide trad catalog setting

| <<mig-1332,1332>>
| data
| lp1981714 default lid owning library setting
...
| <<mig-1336,1336>>
| data
| ouSettings grid ws settings

| <<mig-1342,1342>>
| —
| permit renew when exceeds fines
...
| <<mig-1344,1344>>
| function
| trim trailing punct improvement
...
| <<mig-1347,1347>>
| function
| purge messages curbside notes

| <<mig-1348,1348>>
| data
| renewals use full time

| <<mig-1349,1349>>
| data
| org setting enc desc

| <<mig-1350,1350>>
| function
| lp1978976.merge record notes
...
| <<mig-1352,1352>>
| data
| angular cash reports

| <<mig-1353,1353>>
| data
| default classification description update
...
[[mig-1326]]
=== 1326 — field documentation workstaiton setting
...
[[mig-1331]]
=== 1331 — hide trad catalog setting
...
[[mig-1332]]
=== 1332 — lp1981714 default lid owning library setting
...
[[mig-1334]]
=== 1334 — picklist uploader templates
...
[[mig-1336]]
=== 1336 — ouSettings grid ws settings
...
[[mig-1342]]
=== 1342 — permit renew when exceeds fines
...
[[mig-1344]]
=== 1344 — trim trailing punct improvement
...
[[mig-1347]]
=== 1347 — purge messages curbside notes
...
[[mig-1350]]
=== 1350 — lp1978976.merge record notes
...
[[mig-1353]]
=== 1353 — default classification description update
