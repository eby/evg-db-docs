= Schema Changes: 2.4.0
:description: Database schema changes applied in Evergreen 2.4.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 2.3 → 2.4.0

This release applied 39 migration(s) to the database schema.
...
| <<mig-739,739>>
| —
| remove bypass hold library setting
...
| <<mig-745,745>>
| data
| prewarn expire setting

| <<mig-747,747>>
| data
| frozen holds clear expire time
...
| <<mig-775,775>>
| schema
| config z3950 source attr cascade delete
...
| <<mig-780,780>>
| schema
| acq.distribution formula.expansion
...
| <<mig-782,782>>
| schema
| general indexing needs

| <<mig-785,785>>
| schema
| aoupa unique constraint
...
| <<mig-793,793>>
| data
| best hold order traditional approx

| <<mig-788,788>>
| schema
| reporter 264 pubinfo
...
[[mig-739]]
=== 739 — remove bypass hold library setting
...
[[mig-747]]
=== 747 — frozen holds clear expire time
...
[[mig-758]]
=== 758 — vandelay default match set
...
[[mig-760]]
=== 760 — custom best hold selection
...
[[mig-763]]
=== 763 — truncate to max fine setting
...
[[mig-769]]
=== 769 — unapi exclude invisible acn
...
[[mig-773]]
=== 773 — authority thesaurus update
...
[[mig-775]]
=== 775 — config z3950 source attr cascade delete
...
[[mig-780]]
=== 780 — acq.distribution formula.expansion
...
[[mig-781]]
=== 781 — acq.distribution formula.expansion
...
[[mig-793]]
=== 793 — best hold order traditional approx
