= Schema Changes: 2.6.4
:description: Database schema changes applied in Evergreen 2.6.4
...
| <<mig-892,892>>
| schema
| record attr flat speedup

| <<mig-893,893>>
| schema
| reporter.simple record

| <<mig-894,894>>
| index
| money billing.voider

| <<mig-895,895>>
| data
| ff COM SER seed data
