= Schema Changes: 2.10.0
:description: Database schema changes applied in Evergreen 2.10.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 2.9.3 → 2.10.0
...
| <<mig-946,946>>
| schema
| batch settings retrieve function
...
| <<mig-951,951>>
| schema
| config.standing penalty.ignore proximity
...
| <<mig-953,953>>
| function
| unapi bre.external includes

| <<mig-954,954>>
| schema
| fund debit invoice links

| <<mig-955,955>>
| schema
| password reset regex description
...
| <<mig-962,962>>
| schema
| vandelay parts import

| <<mig-963,963>>
| schema
| config z3950 attr check
...
| <<mig-966,966>>
| schema
| normalize pubdate respect null
...
| <<mig-968,968>>
| data
| new user created notice

| <<mig-969,969>>
| data
| restrict opt to depth setting

| <<mig-970,970>>
| schema
| limit facets pg91 compat
...
[[mig-946]]
=== 946 — batch settings retrieve function
...
[[mig-951]]
=== 951 — config.standing penalty.ignore proximity
...
[[mig-953]]
=== 953 — unapi bre.external includes
...
[[mig-955]]
=== 955 — password reset regex description
...
[[mig-966]]
=== 966 — normalize pubdate respect null
...
[[mig-969]]
=== 969 — restrict opt to depth setting
