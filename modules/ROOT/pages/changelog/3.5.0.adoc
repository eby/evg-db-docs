= Schema Changes: 3.5.0
:description: Database schema changes applied in Evergreen 3.5.0
...
| <<mig-1199,1199>>
| —
| lp1849736 at email self register
...
| <<mig-1201,1201>>
| data
| opac custom css permission

| <<mig-1203,1203>>
| —
| hpprox best hold sort order
...
[[mig-1199]]
=== 1199 — lp1849736 at email self register
...
[[mig-1201]]
=== 1201 — opac custom css permission
...
[[mig-1203]]
=== 1203 — hpprox best hold sort order
