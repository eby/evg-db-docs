= Schema Changes: 3.15.0
:description: Database schema changes applied in Evergreen 3.15.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.14.4 → 3.15.0

This release applied 16 migration(s) to the database schema.
...
| <<mig-1450,1450>>
| data
| ws setting keyboard shortcuts.sq
...
| <<mig-1455,1455>>
| schema
| missing from clause in lasso copy count
...
| <<mig-1459,1459>>
| schema
| opac google analytics

| <<mig-1460,1460>>
| data
| staff client clear long caches

| <<mig-1461,1461>>
| schema
| phone settings index

| <<mig-1462,1462>>
| data
| lp1949243 edi lin seq id

| <<mig-1463,1463>>
| data
| org setting template bar

| <<mig-1464,1464>>
| schema
| lasso item count sums

| <<mig-1465,1465>>
| schema
| staff portal urls newtab

| <<mig-1466,1466>>
| data
| ws setting no newtabs
...
[[mig-1450]]
=== 1450 — ws setting keyboard shortcuts.sq
...
[[mig-1452]]
=== 1452 — place holds for recent patrons
...
[[mig-1455]]
=== 1455 — missing from clause in lasso copy count
...
[[mig-1456]]
=== 1456 — _(file not found in upgrade/ directory)_

_No SQL content available._

[[mig-1458]]
=== 1458 — opac alert settings
...
[[mig-1460]]
=== 1460 — staff client clear long caches
