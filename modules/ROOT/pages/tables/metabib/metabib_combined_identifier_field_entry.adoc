= metabib.combined_identifier_field_entry
:description: Table reference for metabib.combined_identifier_field_entry
...
| `metabib_combined_identifier_field_entry_fakepk_idx` [.label]#UNIQUE#
| btree
...
| `metabib_combined_identifier_field_source_idx`
| btree
