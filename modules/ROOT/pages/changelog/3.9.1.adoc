= Schema Changes: 3.9.1
:description: Database schema changes applied in Evergreen 3.9.1
...
| <<mig-1327,1327>>
| data
| org select combo names

| <<mig-1328,1328>>
| schema
| reject active acpl deleted

| <<mig-1337,1337>>
| data
| ou setting required callno label

| <<mig-1338,1338>>
| schema
| remove invalid search attribute

| <<mig-1339,1339>>
| schema
| course original circ lib

| <<mig-1340,1340>>
| schema
| dym update and reify
...
[[mig-1328]]
=== 1328 — reject active acpl deleted
...
[[mig-1337]]
=== 1337 — ou setting required callno label
...
[[mig-1338]]
=== 1338 — remove invalid search attribute
