= Schema Changes: 2.8.3
:description: Database schema changes applied in Evergreen 2.8.3
...
| <<mig-927,927>>
| schema
| optimize full circ count

| <<mig-936,936>>
| schema
| fix ingest of xpath based attrs
...
[[mig-936]]
=== 936 — fix ingest of xpath based attrs
