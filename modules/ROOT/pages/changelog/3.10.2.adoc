= Schema Changes: 3.10.2
:description: Database schema changes applied in Evergreen 3.10.2

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.10.1 → 3.10.2
...
[[mig-1365]]
=== 1365 — mark tag for match highlights
