= Schema Changes: 3.11.0
:description: Database schema changes applied in Evergreen 3.11.0

xref:../changelog.adoc[↑ Changelog]

*Upgrade:* 3.10.2 → 3.11.0

This release applied 15 migration(s) to the database schema.
...
| <<mig-1354,1354>>
| schema
| drop public flag record notes

| <<mig-1356,1356>>
| data
| typo config global flag history money age with circs update

| <<mig-1357,1357>>
| data
| typo global flag opac located uri act as copy

| <<mig-1358,1358>>
| schema
| fix interval indexes

| <<mig-1363,1363>>
| schema
| action.hold request cancel cause.manual
...
| <<mig-1367,1367>>
| schema
| DYM authority data dictionary

| <<mig-1368,1368>>
| schema
| DYM authority restore delayed reify
...
[[mig-1354]]
=== 1354 — drop public flag record notes
...
[[mig-1356]]
=== 1356 — typo config global flag history money age with circs update
...
[[mig-1357]]
=== 1357 — typo global flag opac located uri act as copy
...
[[mig-1363]]
=== 1363 — action.hold request cancel cause.manual
...
[[mig-1367]]
=== 1367 — DYM authority data dictionary
...
[[mig-1368]]
=== 1368 — DYM authority restore delayed reify
...
[[mig-1372]]
=== 1372 — permission.hold pull list
